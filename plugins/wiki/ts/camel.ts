...
module Wiki {
  ...
  export var CamelController = _module.controller("Wiki.CamelController", ["$scope", "$rootScope", "$location", "$routeParams", "$compile", "$templateCache", "localStorage", ($scope, $rootScope, $location, $routeParams, $compile, $templateCache, localStorage:WindowLocalStorage) => {
